...
async function createCache() {
    try {
        ...
        console.log(`   Expires in   : ${cache.ttlSeconds} seconds (${Math.round(cache.ttlSeconds / 3600)} hours)`);
        ...
        if (error.message.includes('quota') || error.message.includes('limit')) {
            ...
            console.error("   - https://console.cloud.google.com/apis/api/generativeai.googleapis.com/quotas");
