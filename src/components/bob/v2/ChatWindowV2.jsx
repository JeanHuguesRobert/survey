            ...
            <div className="model-modal-centered">
              <div className="model-modal-card">
                <div className="model-modal-body">
                  <div className="model-mode-single">
                    <div className="model-modal-providers">
                      <ProviderStatus
                        providersData={logic.providersStatus}
                        onSelectProvider={handleProviderStatusSelect}
                      />
                    </div>

                    <div className="model-mode-controls">
                          ...
                          {(() => {
                            ...
                            return (
                              <div className="provider-metrics-inline">
                                ...
                                {m.recentlyUsed && (
                                  <span
                                    className="metric-badge metric-hot"
                                    title="Récemment utilisé"
                                  >
                                    🔥
                                  </span>
                                )}
                      ...
                      <div className="model-row">
                        ...
                        <div className="model-metrics">
                          {(() => {
                            ...
                            if (!modelData)
                              return (
                                <div className="metric-hint">Aucune métrique pour ce modèle.</div>
                              );
                            return (
                              <div className="provider-metrics-inline">
                                {modelData.avgResponseTime != null && (
