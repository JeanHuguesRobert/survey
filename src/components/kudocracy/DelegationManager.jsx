...
export default function DelegationManager({ user }) {
  ...
  const availableTags = tags.filter(
    tag => !delegations.some(d => d.tag_id === tag.id)
  );
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
          <p className="text-sm text-blue-800">
            Déléguez votre pouvoir de vote sur des sujets spécifiques à des personnes en qui vous avez confiance.
            Votre vote direct sur une proposition remplace toujours la délégation.
          </p>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h3 className="text-xl font-bold text-gray-900 mb-4">Créer une nouvelle délégation</h3>
