  ...
  if (page === "form") {
    return (
      <div className="min-h-screen bg-gray-50">
        <a
          href="#mainContent"
          className="sr-only focus:not-sr-only fixed top-2 left-2 z-50 px-3 py-2 rounded-md bg-white text-slate-900 shadow"
        >
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="text-center flex-1">
                <div className="mb-4">
                  ...
                  <div
                    className="h-1 my-3 max-w-2xl mx-auto"
                    style={{ backgroundColor: SECONDARY_COLOR }}
                  ></div>
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm" onClick={closeMenu}>
            <nav
              id="mainNav"
              role="navigation"
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <span id="navTitle" className="text-lg font-semibold text-slate-800">
          ...
          {submitted ? (
            <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
              ...
              <p className="text-green-700">
                Votre réponse a été enregistrée. Redirection vers les résultats...
              </p>
            </div>
          ) : (
            <>
                  ...
                  <div id="mainContent" className="bg-white p-8">
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="pl-4" style={{ borderLeft: `4px solid ${SECONDARY_COLOR}` }}>
                        <h2 className="text-xl font-bold text-gray-800 mb-4">
                          Démocratie {getCommunityLabels().name}
                        </h2>
                        ...
                        <div className="mb-6">
                          <label className="block text-gray-700 font-semibold mb-2">
                            Sur quels sujets ces référendums devraient-ils porter ? (choix
                            multiples)
                          </label>
                          <div className="space-y-2">
                            {[
                        ...
                        <div className="mb-6">
                          <label className="block text-gray-700 font-semibold mb-2">
                            Les horaires actuels des conseils municipaux vous paraissent-ils
                            pratiques ?
                          </label>
                          <div className="space-y-2">
          ...
          {!stats ? (
            ...
            <>
              ...
              <div className="space-y-12">
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4">
                    Connaissance de l'affaire de Quasquara
                  </h2>
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4">
                    Satisfaction de la démocratie locale
                  </h2>
                  <div className="text-center">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4">
                    Favorable aux référendums locaux ?
                  </h2>
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
                ...
                {stats.sujetsData.length > 0 && (
                  <div>
                    <h2 className="text-xl font-bold text-gray-800 mb-4">
                      Sujets prioritaires pour les référendums
                    </h2>
                    <ResponsiveContainer width="100%" height={300}>
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4">
                    Les horaires des conseils municipaux
                  </h2>
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
