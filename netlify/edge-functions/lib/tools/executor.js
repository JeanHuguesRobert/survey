...
export async function executeToolCalls(toolCalls, provider = "mistral", fallbackContext = {}) {
    ...
    for (const call of toolCalls) {
        try {
            ...
            console.log(`[${provider}] ➜ Tool call: ${toolName} args=${JSON.stringify(args).slice(0, 400)}`);
            ...
            console.log(`[${provider}] ⬅ Tool result for ${toolName} preview: ${String(output).slice(0, 400)}`);
